                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="g_detail" type="text" name="g_detail" rows="3"
                                        placeholder="กรุณากรอกรายละเอียดประเภทเอกสาร"></textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            <div id="datepicker" class="input-group date">
                                                <input class="form-control" type="text" id="g_date" name="g_date"
                                                    readonly />
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-group">
                                    <label for="g_detail">รายละเอียดประเภทเอกสาร</label>
                                    <textarea class="form-control" id="eg_detail" type="text" name="eg_detail" rows="3"
                                        placeholder="กรุณากรอกรายละเอียดประเภทเอกสาร"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="row">
                                    <div class="col">
                                        <label for="url">ออกโดย</label>
                                        <input type="text" class="form-control" name="eg_address" id="eg_address"
                                            placeholder="สถาบันสุขภาพอาเซียน">
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            <div id="datepicker" class="input-group date">
                                                <input class="form-control" type="text" id="eg_date" name="eg_date"
                                                    readonly />
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-secondary" type="button"><span
                                                            class="input-group-addon">
