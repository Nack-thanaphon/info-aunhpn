    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                <?php include "./activity/activity_type.php" ?>
    ...
    <script>
        $(function() { // เรียกใช้งาน datatable
            $.ajax({
                type: "GET",
                dataType: "JSON",
                url: "../../services/Activity/activity_type/",
                data: {},
            }).done(function(data) {
                let tableData = []
                data = data.result;
                        ...
                        $(document).on('click', '#delete', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        type: "POST",
                                        url: "../../services/Activity/activity_type/delete.php",
                                        data: {
                                            id: id
                                        }
                                    }).done(function() {
        ...
        $('#file_type').on('submit', function(e) { // เรียกใช้งาน เพิ่มข้อมูล (สำคัญ)
            ...
            $.ajax({
                type: 'POST',
                url: "../../services/Activity/activity_type/create.php",
                data: {
                    t_name: $("#t_name").val(),
                },
            }).done(function(resp) {
        ...
        $(document).on('click', '.edit_file_type', function() { // เรียกใช้งาน แก้ไขข้อมูล (MOdal previews)
            let id = $(this).data('id');
            $.ajax({
                url: "../../services/Activity/activity_type/update.php",
                method: "GET",
                data: {
                    id: id
                },
                ...
                success: function(data) {
                    $('#et_id').val(data[0].et_id);
                    $('#et_name').val(data[0].et_name);
