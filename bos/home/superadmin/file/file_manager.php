                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="form">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                <div id="datepicker" class="input-group date">
                                                    <input class="form-control" type="text" id="f_date" name="f_date"
                                                        readonly />
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="custom-file">
                                        <label class="custom-file-label" id="file_name"> *เฉพาะไฟล์ .pdf (ไม่เกิน 15MB
                                            เท่านั้น )
                                        </label>
                            ...
                            <div class="form-group col-sm-12 w-100 ">
                                <button type="submit" id="submit" class="btn btn-primary btn-block mx-auto w-100"
                            ...
                            <div class="form">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="ef_detail" type="text" name="ef_detail"
                                            rows="3" placeholder="กรุณากรอกรายละเอียดเอกสาร"></textarea>
                                    </div>
                                </div>
