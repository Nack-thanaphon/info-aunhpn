                        ...
                        <div class="card-header  border-left-primary text-primary ">
                            <div class="row mx-auto">
                                ...
                                <div class="col-6 text-right">
                                    <button class="btn btn-primary text-white" data-toggle="modal" data-target="#adfile_uploads">เพิ่มเอกสาร</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-pie pt-4 pb-2">
                                ...
                                <canvas id="myPieChart" width="646" height="208" style="display: block; width: 646px; height: 208px;" class="chartjs-render-monitor"></canvas>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="f_name" id="f_name" placeholder="กรุณากรอกชื่อเอกสาร" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label for="n_name">รายละเอียดเอกสาร</label>

                                                <textarea class="form-control" id="f_detail" type="text" name="f_detail" rows="3" placeholder="กรุณากรอกรายละเอียดเอกสาร"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="f_by" id="f_by" placeholder="สถาบันสุขภาพอาเซียน">
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="input-group">
                                                        <div id="datepicker" class="input-group date">
                                                            <input class="form-control" type="text" id="f_date" name="f_date" readonly />
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="n_name">ชื่อเอกสาร</label>
                                            <input type="text" class="form-control" name="ef_name" id="ef_name" placeholder="กรุณากรอกชื่อเอกสาร" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label for="n_name">รายละเอียดเอกสาร</label>

                                                <textarea class="form-control" id="ef_detail" type="text" name="ef_detail" rows="3" placeholder="กรุณากรอกรายละเอียดเอกสาร"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col">
                                                    <label for="url">ออกโดย</label>
                                                    <input type="text" class="form-control" name="ef_by" id="ef_by" placeholder="สถาบันสุขภาพอาเซียน">
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="input-group">
                                                        <div id="datepicker" class="input-group date">
                                                            <input class="form-control" type="text" id="ef_date" name="ef_date" readonly />
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" type="button"><span class="input-group-addon">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </span>
