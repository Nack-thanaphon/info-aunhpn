                        ...
                        <div class="card-header  border-left-primary text-primary ">
                            <div class="row mx-auto">
                                ...
                                <div class="col-6 text-right">
                                    <button class="btn btn-primary text-white" data-toggle="modal" data-target="#adbanner_uploads">+ เพิ่มแบนเนอร์</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="b_title" id="b_title" placeholder="กรุณากรอกชื่อแบนเนอร์" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="n_name">ลิงค์แบนเนอร์(*ถ้ามี)</label>
                                            <input type="text" class="form-control" name="b_link" id="b_link" placeholder="กรุณากรอกลิงค์แบนเนอร์" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label for="n_name">รายละเอียดแบนเนอร์</label>

                                                <textarea class="form-control" id="b_detail" type="text" name="b_detail" rows="3" placeholder="กรุณากรอกรายละเอียดแบนเนอร์"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="b_by" id="b_by" placeholder="สถาบันสุขภาพอาเซียน">
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="input-group">
                                                        <div id="datepicker" class="input-group date">
                                                            <input class="form-control" type="text" id="b_date" name="b_date" readonly />
                                    ...
                                    <div class="form-group col-sm-12 w-100 ">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block mx-auto w-100" name="submit">บันทึกข้อมูล</button>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="b_name">ชื่อแบนเนอร์</label>
                                            <input type="text" class="form-control" name="eb_title" id="eb_title" placeholder="กรุณากรอกชื่อแบนเนอร์" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="n_name">ลิงค์แบนเนอร์(*ถ้ามี)</label>
                                            <input type="text" class="form-control" name="eb_link" id="eb_link" placeholder="กรุณากรอกลิงค์แบนเนอร์" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label for="">รายละเอียดแบนเนอร์</label>
                                                <textarea class="form-control" id="eb_detail" type="text" name="eb_detail" rows="3" placeholder="กรุณากรอกรายละเอียดแบนเนอร์"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col">
                                                    <label for="url">หน่วยงาน / สถาบัน</label>
                                                    <input type="text" class="form-control" name="eb_by" id="eb_by" placeholder="สถาบันสุขภาพอาเซียน">
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="input-group">
                                                        <div id="datepicker" class="input-group date">
                                                            <input class="form-control" type="text" id="eb_date" name="eb_date" readonly />
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" type="button"><span class="input-group-addon">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </span>
